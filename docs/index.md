...
<p align="left"><i>Figure 6b: NaturalQS accuracy (Recall → F1 → EM). DiskANN maintains an edge over IVFPQ even on the lower‑accuracy Natural Questions benchmark.</i></p>
<p align="center">
